...
```javascript
filled3d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-filled3d@v0.2.5-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-filled3d@v0.2.5-umd/browser.js"></script>
```
